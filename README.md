...
<!--     <img src="https://readme-typing-svg.herokuapp.com?color=E22FE4&width=380&height=45&lines=Welcome+To+My+Github;You+Know+Who+Is+Handsome;Akhyar+Azamta;Nice+To+Meet+You+...&center=true"></a> -->
    <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&duration=1500&pause=900&lines=%22Software+engineer+with+years+of+experience+in+developing+web+and+mobile+applications+using+a+variety+of+programming+languages+such+as+Java%2C+Python%2C+and+JavaScript.+Always+interested+in+learning+new+technologies+and+finding+ways+to+effectively+solve+problems.+Enjoy+working+in+teams+or+independently+as+needed+for+the+project.%22" alt="Typing SVG" /></a>
